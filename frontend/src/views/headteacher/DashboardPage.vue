        ...
        <div class="stat-card primary">
          <div class="stat-content">
            ...
            <div class="stat-trend">
              <span class="trend-text">今日出勤</span>
              <span class="trend-value">{{ stats.todayAttendance }}</span>
            </div>
          </div>
        </div>
      </el-col>
      ...
      <el-col :xs="24" :sm="12" :lg="6" class="mb-20">
            <div class="stat-card success">
              <div class="stat-content">
                ...
                <div class="stat-trend">
                  <span class="trend-text">班级人数</span>
          ...
          <el-col :xs="24" :sm="12" :lg="6" class="mb-20">
            <div class="stat-card warning">
              <div class="stat-content">
                <div class="stat-title">待处理变动</div>
          ...
          <el-col :xs="24" :sm="12" :lg="6" class="mb-20">
            <div class="stat-card info">
              <div class="stat-content">
                ...
                <div class="stat-trend">
                  <span class="trend-text">待办</span>
                  <span class="trend-value">{{ todoList.length }}</span>
                </div>
              </div>
            </div>
          </el-col>
...
const fetchDashboardData = async () => {
  try {
    loading.value = true
    const response = await api.dashboard.getHeadTeacherStats()

          ...
          <section class="faq-section">
            ...
            <div class="faq-content">
              <el-collapse v-model="activeNames" accordion>
                ...
                <el-collapse-item name="card" title="授权管理问题">
                  <div class="collapse-content">
                    <p>如何添加新授权？在授权管理页面点击"添加授权"按钮，填写授权密钥、用户信息、有效期等必要信息后保存。</p>
                    <p>授权信息修改失败怎么办？检查必填字段是否完整，授权密钥格式是否正确。确保有足够的权限进行修改操作。</p>
                  </div>
                </el-collapse-item>
                
                <el-collapse-item name="search" title="搜索查询问题">
                  <div class="collapse-content">
                    <p>搜索不到授权怎么办？检查搜索关键词是否正确，确保授权信息已正确录入。可以尝试使用模糊搜索或按不同字段搜索。</p>

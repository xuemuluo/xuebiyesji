    ...
    <div class="parent-layout">
      <header class="parent-header">
        <div class="header-left">
          ...
          <h1 class="logo">StuRegSys <span class="logo-sub">- 家长端</span></h1>
        </div>
...
import { ArrowDown, Calendar, ChatDotRound, Folder, List, Menu, Monitor, Reading, Setting, TrendCharts, User, UserFilled } from '@element-plus/icons-vue'

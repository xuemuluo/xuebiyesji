    ...
    <div class="teacher-layout">
      <header class="teacher-header">
        <div class="header-left">
          ...
          <h1 class="logo">StuRegSys <span class="logo-sub">- 任课教师</span></h1>
        </div>
...
import { ArrowDown, Calendar, ChatDotRound, Document, Edit, Menu, Monitor, Reading, School, User, UserFilled } from '@element-plus/icons-vue'
